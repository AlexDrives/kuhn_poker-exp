...
# ======================================================
# CFR training + exploitability
# ======================================================
def train_cfr(game, iters=2000, log_every=10):
...
def main():
    ...
    plt.grid()
    plt.savefig("cfr_kuhn_exploitability.png", dpi=200)
    print("Saved figure to cfr_kuhn_exploitability.png")
